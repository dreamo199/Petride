...
function OrdersHistoryPage() {
  ...
  const dropdownRef = useRef(null);
    ...
    const handleCancelOrder = async (orderId, status, cancellation_reason) => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const matchesStatus = statusFilter === 'All' || order.status_display === statusFilter;
                    ...
                    <div className="flex gap-3">
                      ...
                      {order.status === 'in Transit' && (
                        <Link
                          ...
                          className="text-[#3b82f6] hover:text-white text-sm transition-colors"
                        >
                          Track
                        </Link>
                      )}
                      {order.status === 'pending' && (
                        <button
                          ...
                          className="text-[#fc0909] hover:text-white text-sm transition-colors"
                        >
                          Cancel
                        </button>
                      )}
